          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Image.asset(logoNoBg,height: height/3,width: width/1.5,),
                ],
              ),
              Image.asset(splash2,width: width,),
              ...
              Expanded(
                child: Padding(
                  ...
                  child: ResponsiveText("First and foremost it’s about giving back to people that helped our fight",textColor: kPrimaryColor,fontFamily: 'RobotoMono',fontSize: 15,),
                ),
              ),
              GestureDetector(
                child: SizedBox(
                  ...
                  child: Container(
                    ...
                    child: ResponsiveText("Get Started",fontSize: 16,fontFamily: 'RobotoMono',textColor: kDefaultIconLightColor,textAlign: TextAlign.center,),
                  ),
                ),
                onTap: (){
                  Get.to(Splash3());
